...
const Form = ({showSelect, placeholderText,courierProvider, inputTrackingId}) => {
  ...
  return (
    ...
    <form onSubmit={handleSubmit}>
      ...
      />
      {showSelect && (
        <select value={selectedCourier} onChange={(e) => setSelectedCourier(e.target.value)} required>
